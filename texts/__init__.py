from texts.reminders import REMINDERS_TEXTS
...
_all_dicts = [
  ...
  GUESS_OUTSIDER_TEXTS, MODE_SETTINGS_TEXTS, CATEGORY_SETTINGS_TEXTS, RESULTS_TEXTS, GENERAL_TEXTS, GAME_REPORT_TEXTS, REMINDERS_TEXTS
]
